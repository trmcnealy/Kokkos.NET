...
//                if (values.empty())
//                {
//                    return LookupRange(System::addressof(values), 0U, 0U);
//                }
//
...
//                if (next == keys.end())
//                {
//                    return LookupRange(System::addressof(values), find->second, values.size());
//                }
//
//                return LookupRange(System::addressof(values), find->second, next->second);
//            }
//
