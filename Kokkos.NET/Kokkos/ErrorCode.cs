...
namespace Kokkos
{
    ...
    public static class ErrorCodeExtension
    {
        ...
        public static string GetErrorMessage(this ErrorCode errorCode)
        {
            switch(errorCode)
            {
                ...
                case ErrorCode.ERROR_SYSTEM_TRACE:
                    return "System trace information was not specified in your CONFIG.SYS file, or tracing is disallowed.";
                case ErrorCode.ERROR_INVALID_EVENT_COUNT:
                    return "The number of specified semaphore events for DosMuxSemWait is not correct.";
                case ErrorCode.ERROR_TOO_MANY_MUXWAITERS:
                    return "DosMuxSemWait did not execute; too many semaphores are already set.";
                case ErrorCode.ERROR_INVALID_LIST_FORMAT:
                    return "The DosMuxSemWait list is not correct.";
                case ErrorCode.ERROR_LABEL_TOO_LONG:
                    return "The volume label you entered exceeds the label character limit of the target file system.";
                case ErrorCode.ERROR_TOO_MANY_TCBS:
                    return "Cannot create another thread.";
                case ErrorCode.ERROR_SIGNAL_REFUSED:
                    return "The recipient process has refused the signal.";
                case ErrorCode.ERROR_DISCARDED:
                    return "The segment is already discarded and cannot be locked.";
                case ErrorCode.ERROR_NOT_LOCKED:
                    return "The segment is already unlocked.";
                case ErrorCode.ERROR_BAD_THREADID_ADDR:
                    return "The address for the thread ID is not correct.";
                case ErrorCode.ERROR_BAD_ARGUMENTS:
                    return "One or more arguments are not correct.";
                case ErrorCode.ERROR_BAD_PATHNAME:
                    return "The specified path is invalid.";
                case ErrorCode.ERROR_SIGNAL_PENDING:
                    return "A signal is already pending.";
                case ErrorCode.ERROR_MAX_THRDS_REACHED:
                    return "No more threads can be created in the system.";
                case ErrorCode.ERROR_LOCK_FAILED:
                    return "Unable to lock a region of a file.";
                case ErrorCode.ERROR_BUSY:
                    return "The requested resource is in use.";
                case ErrorCode.ERROR_DEVICE_SUPPORT_IN_PROGRESS:
                    return "Device's command support detection is in progress.";
                case ErrorCode.ERROR_CANCEL_VIOLATION:
                    return "A lock request was not outstanding for the supplied cancel region.";
                case ErrorCode.ERROR_ATOMIC_LOCKS_NOT_SUPPORTED:
                    return "The file system does not support atomic changes to the lock type.";
                case ErrorCode.ERROR_INVALID_SEGMENT_NUMBER:
                    return "The system detected a segment number that was not correct.";
                case ErrorCode.ERROR_INVALID_ORDINAL:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_ALREADY_EXISTS:
                    return "Cannot create a file when that file already exists.";
                case ErrorCode.ERROR_INVALID_FLAG_NUMBER:
                    return "The flag passed is not correct.";
                case ErrorCode.ERROR_SEM_NOT_FOUND:
                    return "The specified system semaphore name was not found.";
                case ErrorCode.ERROR_INVALID_STARTING_CODESEG:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_INVALID_STACKSEG:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_INVALID_MODULETYPE:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_INVALID_EXE_SIGNATURE:
                    return "Cannot run 1% in Win32 mode.";
                case ErrorCode.ERROR_EXE_MARKED_INVALID:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_BAD_EXE_FORMAT:
                    return "1% is not a valid Win32 application.";
                case ErrorCode.ERROR_ITERATED_DATA_EXCEEDS_64k:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_INVALID_MINALLOCSIZE:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_DYNLINK_FROM_INVALID_RING:
                    return "The operating system cannot run this application program.";
                case ErrorCode.ERROR_IOPL_NOT_ENABLED:
                    return "The operating system is not presently configured to run this application.";
                case ErrorCode.ERROR_INVALID_SEGDPL:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_AUTODATASEG_EXCEEDS_64k:
                    return "The operating system cannot run this application program.";
                case ErrorCode.ERROR_RING2SEG_MUST_BE_MOVABLE:
                    return "The code segment cannot be greater than or equal to 64K.";
                case ErrorCode.ERROR_RELOC_CHAIN_XEEDS_SEGLIM:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_INFLOOP_IN_RELOC_CHAIN:
                    return "The operating system cannot run 1.00%";
                case ErrorCode.ERROR_ENVVAR_NOT_FOUND:
                    return "The system could not find the environment option that was entered.";
                case ErrorCode.ERROR_NO_SIGNAL_SENT:
                    return "No process in the command subtree has a signal handler.";
                case ErrorCode.ERROR_FILENAME_EXCED_RANGE:
                    return "The filename or extension is too long.";
                case ErrorCode.ERROR_RING2_STACK_IN_USE:
                    return "The ring 2 stack is in use.";
                case ErrorCode.ERROR_META_EXPANSION_TOO_LONG:
                    return "The global filename characters, * or ?, are entered incorrectly or too many global filename characters are specified.";
                case ErrorCode.ERROR_INVALID_SIGNAL_NUMBER:
                    return "The signal being posted is not correct.";
                case ErrorCode.ERROR_THREAD_1_INACTIVE:
                    return "The signal handler cannot be set.";
                case ErrorCode.ERROR_LOCKED:
                    return "The segment is locked and cannot be reallocated.";
                case ErrorCode.ERROR_TOO_MANY_MODULES:
                    return "Too many dynamic-link modules are attached to this program or dynamic-link module.";
                case ErrorCode.ERROR_NESTING_NOT_ALLOWED:
                    return "Cannot nest calls to LoadModule.";
                case ErrorCode.ERROR_EXE_MACHINE_TYPE_MISMATCH:
                    return
                        "This version of 1% is not compatible with the version of Windows you're running. Check your computer's system information and then contact the software publisher.";
                case ErrorCode.ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY:
                    return "The image file 1% is signed, unable to modify.";
                case ErrorCode.ERROR_EXE_CANNOT_MODIFY_STRONG_SIGNED_BINARY:
                    return "The image file 1% is strong signed, unable to modify.";
                case ErrorCode.ERROR_FILE_CHECKED_OUT:
                    return "This file is checked out or locked for editing by another user.";
                case ErrorCode.ERROR_CHECKOUT_REQUIRED:
                    return "The file must be checked out before saving changes.";
                case ErrorCode.ERROR_BAD_FILE_TYPE:
                    return "The file type being saved or retrieved has been blocked.";
                case ErrorCode.ERROR_FILE_TOO_LARGE:
                    return "The file size exceeds the limit allowed and cannot be saved.";
                case ErrorCode.ERROR_FORMS_AUTH_REQUIRED:
                    return
                        "Access Denied. Before opening files in this location, you must first add the web site to your trusted sites list, browse to the web site, and select the option to login automatically.";
                case ErrorCode.ERROR_VIRUS_INFECTED:
                    return "Operation did not complete successfully because the file contains a virus or potentially unwanted software.";
                case ErrorCode.ERROR_VIRUS_DELETED:
                    return
                        "This file contains a virus or potentially unwanted software and cannot be opened. Due to the nature of this virus or potentially unwanted software, the file has been removed from this location.";
                case ErrorCode.ERROR_PIPE_LOCAL:
                    return "The pipe is local.";
                case ErrorCode.ERROR_BAD_PIPE:
                    return "The pipe state is invalid.";
                case ErrorCode.ERROR_PIPE_BUSY:
                    return "All pipe instances are busy.";
                case ErrorCode.ERROR_NO_DATA:
                    return "The pipe is being closed.";
                case ErrorCode.ERROR_PIPE_NOT_CONNECTED:
                    return "No process is on the other end of the pipe.";
                case ErrorCode.ERROR_MORE_DATA:
                    return "More data is available.";
                case ErrorCode.ERROR_NO_WORK_DONE:
                    return "The action requested resulted in no work being done. Error-style clean-up has been performed.";
                case ErrorCode.ERROR_VC_DISCONNECTED:
                    return "The session was canceled.";
                case ErrorCode.ERROR_INVALID_EA_NAME:
                    return "The specified extended attribute name was invalid.";
                case ErrorCode.ERROR_EA_LIST_INCONSISTENT:
                    return "The extended attributes are inconsistent.";
                case ErrorCode.WAIT_TIMEOUT:
                    return "The wait operation timed out.";
                case ErrorCode.ERROR_NO_MORE_ITEMS:
                    return "No more data is available.";
                case ErrorCode.ERROR_CANNOT_COPY:
                    return "The copy functions cannot be used.";
                case ErrorCode.ERROR_DIRECTORY:
                    return "The directory name is invalid.";
                case ErrorCode.ERROR_EAS_DIDNT_FIT:
                    return "The extended attributes did not fit in the buffer.";
                case ErrorCode.ERROR_EA_FILE_CORRUPT:
                    return "The extended attribute file on the mounted file system is corrupt.";
                case ErrorCode.ERROR_EA_TABLE_FULL:
                    return "The extended attribute table file is full.";
                case ErrorCode.ERROR_INVALID_EA_HANDLE:
                    return "The specified extended attribute handle is invalid.";
                case ErrorCode.ERROR_EAS_NOT_SUPPORTED:
                    return "The mounted file system does not support extended attributes.";
                case ErrorCode.ERROR_NOT_OWNER:
                    return "Attempt to release mutex not owned by caller.";
                case ErrorCode.ERROR_TOO_MANY_POSTS:
                    return "Too many posts were made to a semaphore.";
                case ErrorCode.ERROR_PARTIAL_COPY:
                    return "Only part of a ReadProcessMemory or WriteProcessMemory request was completed.";
                case ErrorCode.ERROR_OPLOCK_NOT_GRANTED:
                    return "The oplock request is denied.";
                case ErrorCode.ERROR_INVALID_OPLOCK_PROTOCOL:
                    return "An invalid oplock acknowledgment was received by the system.";
                case ErrorCode.ERROR_DISK_TOO_FRAGMENTED:
                    return "The volume is too fragmented to complete this operation.";
                case ErrorCode.ERROR_DELETE_PENDING:
                    return "The file cannot be opened because it is in the process of being deleted.";
                case ErrorCode.ERROR_INCOMPATIBLE_WITH_GLOBAL_SHORT_NAME_REGISTRY_SETTING:
                    return "Short name settings may not be changed on this volume due to the global registry setting.";
                case ErrorCode.ERROR_SHORT_NAMES_NOT_ENABLED_ON_VOLUME:
                    return "Short names are not enabled on this volume.";
                case ErrorCode.ERROR_SECURITY_STREAM_IS_INCONSISTENT:
                    return "The security stream for the given volume is in an inconsistent state. Please run CHKDSK on the volume.";
                case ErrorCode.ERROR_INVALID_LOCK_RANGE:
                    return "A requested file lock operation cannot be processed due to an invalid byte range.";
                case ErrorCode.ERROR_IMAGE_SUBSYSTEM_NOT_PRESENT:
                    return "The subsystem needed to support the image type is not present.";
                case ErrorCode.ERROR_NOTIFICATION_GUID_ALREADY_DEFINED:
                    return "The specified file already has a notification GUID associated with it.";
                case ErrorCode.ERROR_INVALID_EXCEPTION_HANDLER:
                    return "An invalid exception handler routine has been detected.";
                case ErrorCode.ERROR_DUPLICATE_PRIVILEGES:
                    return "Duplicate privileges were specified for the token.";
                case ErrorCode.ERROR_NO_RANGES_PROCESSED:
                    return "No ranges for the specified operation were able to be processed.";
                case ErrorCode.ERROR_NOT_ALLOWED_ON_SYSTEM_FILE:
                    return "Operation is not allowed on a file system public file.";
                case ErrorCode.ERROR_DISK_RESOURCES_EXHAUSTED:
                    return "The physical resources of this disk have been exhausted.";
                case ErrorCode.ERROR_INVALID_TOKEN:
                    return "The token representing the data is invalid.";
                case ErrorCode.ERROR_DEVICE_FEATURE_NOT_SUPPORTED:
                    return "The device does not support the command feature.";
                case ErrorCode.ERROR_MR_MID_NOT_FOUND:
                    return "The system cannot find message text for message number 0x%1 in the message file for 2.00%";
                case ErrorCode.ERROR_SCOPE_NOT_FOUND:
                    return "The scope specified was not found.";
                case ErrorCode.ERROR_UNDEFINED_SCOPE:
                    return "The Central Access Policy specified is not defined on the target machine.";
                case ErrorCode.ERROR_INVALID_CAP:
                    return "The Central Access Policy obtained from Active Directory is invalid.";
                case ErrorCode.ERROR_DEVICE_UNREACHABLE:
                    return "The device is unreachable.";
                case ErrorCode.ERROR_DEVICE_NO_RESOURCES:
                    return "The target device has insufficient resources to complete the operation.";
                case ErrorCode.ERROR_DATA_CHECKSUM_ERROR:
                    return "A data integrity checksum error occurred. Data in the file stream is corrupt.";
                case ErrorCode.ERROR_INTERMIXED_KERNEL_EA_OPERATION:
                    return "An attempt was made to modify both a KERNEL and normal Extended Attribute EA) in the same operation.";
                case ErrorCode.ERROR_FILE_LEVEL_TRIM_NOT_SUPPORTED:
                    return "Device does not support file-level TRIM.";
                case ErrorCode.ERROR_OFFSET_ALIGNMENT_VIOLATION:
                    return "The command specified a data offset that does not align to the device's granularity/alignment.";
                case ErrorCode.ERROR_INVALID_FIELD_IN_PARAMETER_LIST:
                    return "The command specified an invalid field in its parameter list.";
                case ErrorCode.ERROR_OPERATION_IN_PROGRESS:
                    return "An operation is currently in progress with the device.";
                case ErrorCode.ERROR_BAD_DEVICE_PATH:
                    return "An attempt was made to send down the command via an invalid path to the target device.";
                case ErrorCode.ERROR_TOO_MANY_DESCRIPTORS:
                    return "The command specified a number of descriptors that exceeded the maximum supported by the device.";
                case ErrorCode.ERROR_SCRUB_DATA_DISABLED:
                    return "Scrub is disabled on the specified file.";
                case ErrorCode.ERROR_NOT_REDUNDANT_STORAGE:
                    return "The storage device does not provide redundancy.";
                case ErrorCode.ERROR_RESIDENT_FILE_NOT_SUPPORTED:
                    return "An operation is not supported on a resident file.";
                case ErrorCode.ERROR_COMPRESSED_FILE_NOT_SUPPORTED:
                    return "An operation is not supported on a compressed file.";
                case ErrorCode.ERROR_DIRECTORY_NOT_SUPPORTED:
                    return "An operation is not supported on a directory.";
                case ErrorCode.ERROR_NOT_READ_FROM_COPY:
                    return "The specified copy of the requested data could not be read.";
                case ErrorCode.ERROR_FT_WRITE_FAILURE:
                    return "The specified data could not be written to any of the copies.";
                case ErrorCode.ERROR_FT_DI_SCAN_REQUIRED:
                    return "One or more copies of data on this device may be out of sync. No writes may be performed until a data integrity scan is completed.";
                case ErrorCode.ERROR_INVALID_KERNEL_INFO_VERSION:
                    return "The supplied kernel information version is invalid.";
                case ErrorCode.ERROR_INVALID_PEP_INFO_VERSION:
                    return "The supplied PEP information version is invalid.";
                case ErrorCode.ERROR_OBJECT_NOT_EXTERNALLY_BACKED:
                    return "This object is not externally backed by any provider.";
                case ErrorCode.ERROR_EXTERNAL_BACKING_PROVIDER_UNKNOWN:
                    return "The external backing provider is not recognized.";
                case ErrorCode.ERROR_COMPRESSION_NOT_BENEFICIAL:
                    return "Compressing this object would not save space.";
                case ErrorCode.ERROR_STORAGE_TOPOLOGY_ID_MISMATCH:
                    return "The request failed due to a storage topology ID mismatch.";
                case ErrorCode.ERROR_BLOCKED_BY_PARENTAL_CONTROLS:
                    return "The operation was blocked by parental controls.";
                case ErrorCode.ERROR_BLOCK_TOO_MANY_REFERENCES:
                    return "A file system block being referenced has already reached the maximum reference count and can't be referenced any further.";
                case ErrorCode.ERROR_MARKED_TO_DISALLOW_WRITES:
                    return "The requested operation failed because the file stream is marked to disallow writes.";
                case ErrorCode.ERROR_ENCLAVE_FAILURE:
                    return "The requested operation failed with an architecture-specific failure code.";
                case ErrorCode.ERROR_FAIL_NOACTION_REBOOT:
                    return "No action was taken as a system reboot is required.";
                case ErrorCode.ERROR_FAIL_SHUTDOWN:
                    return "The shutdown operation failed.";
                case ErrorCode.ERROR_FAIL_RESTART:
                    return "The restart operation failed.";
                case ErrorCode.ERROR_MAX_SESSIONS_REACHED:
                    return "The maximum number of sessions has been reached.";
                case ErrorCode.ERROR_NETWORK_ACCESS_DENIED_EDP:
                    return "Windows Information Protection policy does not allow access to this network resource.";
                case ErrorCode.ERROR_DEVICE_HINT_NAME_BUFFER_TOO_SMALL:
                    return "The device hint name buffer is too small to receive the remaining name.";
                case ErrorCode.ERROR_EDP_POLICY_DENIES_OPERATION:
                    return "The requested operation was blocked by Windows Information Protection policy. For more information, contact your system administrator.";
                case ErrorCode.ERROR_EDP_DPL_POLICY_CANT_BE_SATISFIED:
                    return
                ...
                case ErrorCode.ERROR_CLOUD_FILE_SYNC_ROOT_METADATA_CORRUPT:
                    return "The cloud sync root metadata is corrupted.";
                case ErrorCode.ERROR_DEVICE_IN_MAINTENANCE:
                    return "The device is in maintenance mode.";
                case ErrorCode.ERROR_NOT_SUPPORTED_ON_DAX:
                    return "This operation is not supported on a DAX volume.";
                case ErrorCode.ERROR_DAX_MAPPING_EXISTS:
                    return "The volume has active DAX mappings.";
                case ErrorCode.ERROR_CLOUD_FILE_PROVIDER_NOT_RUNNING:
                    return "The cloud file provider is not running.";
                case ErrorCode.ERROR_CLOUD_FILE_METADATA_CORRUPT:
                    return "The cloud file metadata is corrupt and unreadable.";
                case ErrorCode.ERROR_CLOUD_FILE_METADATA_TOO_LARGE:
                    return "The cloud file metadata is too large.";
                case ErrorCode.ERROR_CLOUD_FILE_PROPERTY_BLOB_TOO_LARGE:
                    return "The cloud file property is too large.";
                case ErrorCode.ERROR_CLOUD_FILE_PROPERTY_BLOB_CHECKSUM_MISMATCH:
                    return "The cloud file property is possibly corrupt. The on-disk checksum does not match the computed checksum.";
                case ErrorCode.ERROR_CHILD_PROCESS_BLOCKED:
                    return "The process creation has been blocked.";
                case ErrorCode.ERROR_STORAGE_LOST_DATA_PERSISTENCE:
                    return "The storage device has lost data or persistence.";
                case ErrorCode.ERROR_FILE_SYSTEM_VIRTUALIZATION_UNAVAILABLE:
                    return "The provider that supports file system virtualization is temporarily unavailable.";
                case ErrorCode.ERROR_FILE_SYSTEM_VIRTUALIZATION_METADATA_CORRUPT:
                    return "The metadata for file system virtualization is corrupt and unreadable.";
                case ErrorCode.ERROR_FILE_SYSTEM_VIRTUALIZATION_BUSY:
                    return "The provider that supports file system virtualization is too busy to complete this operation.";
                case ErrorCode.ERROR_FILE_SYSTEM_VIRTUALIZATION_PROVIDER_UNKNOWN:
                    return "The provider that supports file system virtualization is unknown.";
                case ErrorCode.ERROR_GDI_HANDLE_LEAK:
                    return "GDI handles were potentially leaked by the application.";
                case ErrorCode.ERROR_CLOUD_FILE_TOO_MANY_PROPERTY_BLOBS:
                    return "The maximum number of cloud file properties has been reached.";
                case ErrorCode.ERROR_CLOUD_FILE_PROPERTY_VERSION_NOT_SUPPORTED:
                    return "The version of the cloud file property store is not supported.";
                case ErrorCode.ERROR_NOT_A_CLOUD_FILE:
                    return "The file is not a cloud file.";
                case ErrorCode.ERROR_CLOUD_FILE_NOT_IN_SYNC:
                    return "The file is not in sync with the cloud.";
                case ErrorCode.ERROR_CLOUD_FILE_ALREADY_CONNECTED:
                    return "The cloud sync root is already connected with another cloud sync provider.";
                case ErrorCode.ERROR_CLOUD_FILE_NOT_SUPPORTED:
                    return "The operation is not supported by the cloud sync provider.";
                case ErrorCode.ERROR_CLOUD_FILE_INVALID_REQUEST:
                    return "The cloud operation is invalid.";
                case ErrorCode.ERROR_CLOUD_FILE_READ_ONLY_VOLUME:
                    return "The cloud operation is not supported on a read-only volume.";
                case ErrorCode.ERROR_CLOUD_FILE_CONNECTED_PROVIDER_ONLY:
                    return "The operation is reserved for a connected cloud sync provider.";
                case ErrorCode.ERROR_CLOUD_FILE_VALIDATION_FAILED:
                    return "The cloud sync provider failed to validate the downloaded data.";
                case ErrorCode.ERROR_SMB1_NOT_AVAILABLE:
                    return
                ...
                case ErrorCode.ERROR_FILE_SYSTEM_VIRTUALIZATION_INVALID_OPERATION:
                    return "The virtualization operation is not allowed on the file in its current state.";
                case ErrorCode.ERROR_CLOUD_FILE_AUTHENTICATION_FAILED:
                    return "The cloud sync provider failed user authentication.";
                case ErrorCode.ERROR_CLOUD_FILE_INSUFFICIENT_RESOURCES:
                    return "The cloud sync provider failed to perform the operation due to low system resources.";
                case ErrorCode.ERROR_CLOUD_FILE_NETWORK_UNAVAILABLE:
                    return "The cloud sync provider failed to perform the operation due to network being unavailable.";
                case ErrorCode.ERROR_CLOUD_FILE_UNSUCCESSFUL:
                    return "The cloud operation was unsuccessful.";
                case ErrorCode.ERROR_CLOUD_FILE_NOT_UNDER_SYNC_ROOT:
                    return "The operation is only supported on files under a cloud sync root.";
                case ErrorCode.ERROR_CLOUD_FILE_IN_USE:
                    return "The operation cannot be performed on cloud files in use.";
                case ErrorCode.ERROR_CLOUD_FILE_PINNED:
                    return "The operation cannot be performed on pinned cloud files.";
                case ErrorCode.ERROR_CLOUD_FILE_REQUEST_ABORTED:
                    return "The cloud operation was aborted.";
                case ErrorCode.ERROR_CLOUD_FILE_PROPERTY_CORRUPT:
                    return "The cloud file's property store is corrupt.";
                case ErrorCode.ERROR_CLOUD_FILE_ACCESS_DENIED:
                    return "Access to the cloud file is denied.";
                case ErrorCode.ERROR_CLOUD_FILE_INCOMPATIBLE_HARDLINKS:
                    return "The cloud operation cannot be performed on a file with incompatible hardlinks.";
                case ErrorCode.ERROR_CLOUD_FILE_PROPERTY_LOCK_CONFLICT:
                    return "The operation failed due to a conflicting cloud file property lock.";
                case ErrorCode.ERROR_CLOUD_FILE_REQUEST_CANCELED:
                    return "The cloud operation was canceled by user.";
                case ErrorCode.ERROR_EXTERNAL_SYSKEY_NOT_SUPPORTED:
                    return
                ...
                case ErrorCode.ERROR_THREAD_MODE_ALREADY_BACKGROUND:
                    return "The thread is already in background processing mode.";
                case ErrorCode.ERROR_THREAD_MODE_NOT_BACKGROUND:
                    return "The thread is not in background processing mode.";
                case ErrorCode.ERROR_PROCESS_MODE_ALREADY_BACKGROUND:
                    return "The process is already in background processing mode.";
                case ErrorCode.ERROR_PROCESS_MODE_NOT_BACKGROUND:
                    return "The process is not in background processing mode.";
                case ErrorCode.ERROR_CLOUD_FILE_PROVIDER_TERMINATED:
                    return "The cloud file provider exited unexpectedly.";
                case ErrorCode.ERROR_NOT_A_CLOUD_SYNC_ROOT:
                    return "The file is not a cloud sync root.";
                case ErrorCode.ERROR_FILE_PROTECTED_UNDER_DPL:
                    return "File is not accessible because it's currently protected under DPL.";
                case ErrorCode.ERROR_VOLUME_NOT_CLUSTER_ALIGNED:
                    return "The volume is not cluster aligned on the disk.";
                case ErrorCode.ERROR_NO_PHYSICALLY_ALIGNED_FREE_SPACE_FOUND:
                    return "No physically aligned free space was found on the volume.";
                case ErrorCode.ERROR_APPX_FILE_NOT_ENCRYPTED:
                    return "The APPX file can not be accessed because it is not encrypted as expected.";
                case ErrorCode.ERROR_RWRAW_ENCRYPTED_FILE_NOT_ENCRYPTED:
                    return "A read or write of raw encrypted data cannot be performed because the file is not encrypted.";
                case ErrorCode.ERROR_RWRAW_ENCRYPTED_INVALID_EDATAINFO_FILEOFFSET:
                    return "An invalid file offset in the encrypted data info block was passed for read or write operation of file's raw encrypted data.";
                case ErrorCode.ERROR_RWRAW_ENCRYPTED_INVALID_EDATAINFO_FILERANGE:
                    return "An invalid offset and length combination in the encrypted data info block was passed for read or write operation of file's raw encrypted data.";
                case ErrorCode.ERROR_RWRAW_ENCRYPTED_INVALID_EDATAINFO_PARAMETER:
                    return "An invalid parameter in the encrypted data info block was passed for read or write operation of file's raw encrypted data.";
                case ErrorCode.ERROR_LINUX_SUBSYSTEM_NOT_PRESENT:
                    return "The Windows Subsystem for Linux has not been enabled.";
                default:
        ...
        {
            if(errorCode != ErrorCode.ERROR_SUCCESS && errorCode != ErrorCode.ERROR_NO_TOKEN)
            {
                ...
                throw new Exception(errorMessage + " " + errorCode.GetErrorMessage());
            }
    ...
    public enum ErrorCode : ulong
    {
        ...
        DNS_ERROR_PACKET_FMT_BASE                                                 = 9500L,
        ...
        DNS_ERROR_GENERAL_API_BASE                                                = 9550L,
